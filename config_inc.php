...
define('VIRTUAL_PATH', 'http://tianagreisel.com/wn16/'); # Virtual (web) 'root' of application for images, JS & CSS files
define('PHYSICAL_PATH', '/home/tiagre1/tianagreisel.com/wn16/'); # Physical (PHP) 'root' of application for file & upload reference
...
define('SUPPORT_EMAIL', 'tianagreisel@gmail.com'); # Email of site support
define('PREFIX', 'wn16_'); #Prefix to add uniqueness to your DB table names.  Limits hackability, naming collisions
...
$nav1['news/p3_list.php'] = "News~The entrance to our News App";
